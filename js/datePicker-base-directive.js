...
var datePickerBase = angular.module('datePicker.base', []);

datePickerBase
    .directive('datePicker', function () {
        return {
            restrict: "EA",
            templateUrl: "./templates/datePicker-base.tpl.html",
            replace: true,
            transclude: true,
            scope: {
                dpConfig: '=dpConfig'
    ...
    }).controller('DatePickerController', ['$scope', '$element', function ($scope, $element) {
        var self = this,
