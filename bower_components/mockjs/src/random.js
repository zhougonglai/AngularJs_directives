...
/*
    ...
    在浏览器中，为了减少需要拼写的字符，Mock.app 把 Mock.Random 暴露给了 window 对象，使之称为全局变量，从而可以直接访问 Random。因此上面例子中的 `var Random = Mock.Random;` 可以省略。在后面的例子中，也将做同样的处理。

    > 在 Node.app 中，仍然需要通过 `Mock.Random` 访问。
    ...
    Mock.app 的 [在线编辑器](http://mockjs.com/mock.html) 演示了完整的语法规则和占位符。
    ...
    Random.extend({
        ...
        */
        ...
        /*
            ...
            * 参数 format：可选。指示生成的日期字符串的格式。默认值为 `yyyy-MM-dd`。可选的占位符参考自 [Ext.Date](http://docs.sencha.com/ext-app/4-1/#!/api/Ext.Date)，如下所示：
        ...
        */
        ...
        /*
            ...
            * 参数 format：可选。指示生成的时间字符串的格式。默认值为 `HH:mm:ss`。可选的占位符参考自 [Ext.Date](http://docs.sencha.com/ext-app/4-1/#!/api/Ext.Date)，请参见 [Random.date(format)](#Random.date(format))。
        ...
        */
        ...
        /*
            ...
            * 参数 format：可选。指示生成的日期和时间字符串的格式。默认值为 `yyyy-MM-dd HH:mm:ss`。可选的占位符参考自 [Ext.Date](http://docs.sencha.com/ext-app/4-1/#!/api/Ext.Date)，请参见 [Random.date(format)](#Random.date(format))。
    ...
    Random.extend({
        ...
        /*
            ...
            **使用示例**如下所示：
                ...
                Random.img('200x100', '#ffcc33', '#FFF', 'png', 'app')
                // => "http://dummyimage.com/200x100/ffcc33/FFF.png&text=app"
